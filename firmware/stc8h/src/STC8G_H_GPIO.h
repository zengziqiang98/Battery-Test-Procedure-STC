...
// 控制信号
sbit FAN_CTRL        = P2^4;   // 风扇开关控制
sbit DISCHARGE_CTRL  = P2^3;   // 放电开关控制
sbit CHARGE_CTRL     = P2^0;   // 充电开关控制

// 设置信号
sbit CHG_CURRENT_SET = P2^1;   // 充电电流设置
sbit CHG_VOLT_SET_1  = P3^2;   // 充电电压设置1
sbit CHG_VOLT_SET_2  = P3^3;   // 充电电压设置2

// 检测信号
sbit BAT_VOLT_SENSE        = P0^0;   // 电池电压检测
sbit BAT_CHG_CURRENT_SENSE = P0^1;   // 充电电流检测
sbit BAT_DISCHG_CURRENT_SENSE = P1^0; // 放电电流检测

// 指示灯
sbit CHG_LED     = P1^3;   // 充电指示灯
sbit DISCHG_LED  = P1^1;   // 放电指示灯
