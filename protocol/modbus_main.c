...
static void mb_process(void)
{
    ...
    /* 地址检查 (29 = 硬件0x1C+1) */
    if(RX1_Buffer[0]!=29&&RX1_Buffer[0]!=0)goto done;
    ...
    case 0x03:
        ...
        RX1_Buffer[0]=29;RX1_Buffer[1]=0x03;RX1_Buffer[2]=cnt*2;
    ...
    case 0x10:if(len<9||RX1_Buffer[6]!=cnt*2)goto ex;for(i=0;i<cnt;i++){val=((unsigned short)RX1_Buffer[7+i*2]<<8)|RX1_Buffer[8+i*2];if(!mb_write(addr+i,val))goto ex;}
        RX1_Buffer[0]=29;RX1_Buffer[1]=0x10;for(i=2;i<6;i++)RX1_Buffer[i]=RX1_Buffer[i];crc=crc16(RX1_Buffer,6);RX1_Buffer[6]=crc&0xFF;RX1_Buffer[7]=crc>>8;
        for(i=0;i<8;i++)TX1_write2buff(RX1_Buffer[i]);break;
    default:goto ex;
    }
    goto done;
ex:
    RX1_Buffer[0]=29;RX1_Buffer[1]=fc|0x80;RX1_Buffer[2]=0x02;crc=crc16(RX1_Buffer,3);RX1_Buffer[3]=crc&0xFF;RX1_Buffer[4]=crc>>8;
...
void SetChargeParamsByBatteryType(void){switch(batteryType){case 0:CHG_VOLT_SET_1=0;CHG_VOLT_SET_2=0;CHG_CURRENT_SET_Pwm=100;overchargeProtectVolt=21500;overdischargeProtectVolt=12000;break;case 1:CHG_VOLT_SET_1=1;CHG_VOLT_SET_2=1;CHG_CURRENT_SET_Pwm=50;overchargeProtectVolt=17500;overdischargeProtectVolt=10000;break;case 2:CHG_VOLT_SET_1=1;CHG_VOLT_SET_2=1;CHG_CURRENT_SET_Pwm=50;overchargeProtectVolt=15000;overdischargeProtectVolt=8500;break;}}
